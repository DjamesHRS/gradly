...
<head>
    <meta charset="UTF-8"/>
    <title>Gradly — Dashboard do Orientador</title>
    ...
    <style>
        ...
        *,*::before,*::after{box-sizing:border-box;margin:0;padding:0;}
        ...
        .sbadge.error::before{content:'';width:6px;height:6px;border-radius:50%;background:#ef4444;}
        ...
        .proj-docs{padding:1rem 1.25rem;border-top:1px solid #c1ccda;}
        ...
        .proj-doc{padding:.6rem .75rem;border:1px solid #c1ccda;border-radius:var(--r-lg);background:var(--surface2);margin-bottom:.6rem;}
