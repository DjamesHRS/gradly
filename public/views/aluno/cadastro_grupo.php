...
<head>
  <meta charset="UTF-8"/>
  <title>Gradly — Criar Grupo</title>
  ...
  <main class="main">
    <div class="content">
      <div class="content-main">
        <h1 class="page-title fi fi-1">Criar Grupo</h1>

        <div class="proj-card fi fi-2">
          <div class="proj-header">
            <h3 class="proj-card-title">Dados do Grupo</h3>
            <div class="muted">Preencha as informações e clique em "Criar Grupo"</div>
          </div>

          <div class="card-body">
            <form id="form_criar_grupo" action="#" method="POST" novalidate>
                <div class="cmb-3">
                    <label class="form-label">Nome</label>
                    <input id="nome" type="text" name="nome" class="form-control" placeholder="Informe o nome do grupo" required>
                </div>

                <div class="mb-3">
                    <label class="form-label">Descrição</label>
                    <input id="descricao" type="text" name="descricao" class="form-control" placeholder="Informe a descrição do grupo" required>
                </div>

                <div class="mb-3">
                    <label class="form-label">Email do Participante</label>
                        <div class="d-flex gap-2">
                            <input id="email" type="text" name="email" class="form-control" placeholder="Informe o email dos participantes" required>
